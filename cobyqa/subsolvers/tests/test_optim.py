...
class TestTangentialByrdOmojokun:
    ...
    def test_improve(self, n):
        ...
        for seed in range(100):
            ...
            assert (
                grad @ step + 0.5 * step @ hess @ step
                <= grad @ step_base + 0.5 * step_base @ hess @ step_base
            )
...
class TestConstrainedTangentialByrdOmojokun:
    ...
    def test_improve(self, n, m_ub, m_eq):
        ...
        for seed in range(100):
            ...
            # Solve the same subproblem without the improving strategy.
            step_base = constrained_tangential_byrd_omojokun(
                grad,
                lambda s: hess @ s,
                xl,
                xu,
            ...
            assert (
                grad @ step + 0.5 * step @ hess @ step
                < grad @ step_base + 0.5 * step_base @ hess @ step_base + tol
            )
...
class TestNormalByrdOmojokun:
    ...
    def test_simple(self, n, m_ub, m_eq):
        ...
        for seed in range(100):
            ...
            assert (
                ...
                <= resid_ub_zero @ resid_ub_zero + beq @ beq
            )
    ...
    def test_improve(self, n, m_ub, m_eq):
        ...
        for seed in range(100):
            ...
            assert (
                resid_ub @ resid_ub + resid_eq @ resid_eq
                <= resid_ub_base @ resid_ub_base
                + resid_eq_base @ resid_eq_base
            )
